...
export default function ExperimentsBanner({ size }) {
  return (
    <a
      className="experiments_banner"
      className={classnames('experiments_banner', {
        'is-small': size === 'small'
      })}
    ...
    >
      <div className="experiments_banner-inner">
        <div className="experiments_banner-emoji_wrapper">
          <Emoji />
        </div>
        <div className="experiments_banner-text">
...
function Emoji() {
  return (
    <svg viewBox="0 0 47.5 47.5" className="experiments_banner-emoji">
      <defs>
...
function Icon() {
  return (
    <svg viewBox="0 0 512 512" className="experiments_banner-icon">
