      ...
      <div className='testimonials-list'>
        <div className='testimonials-item'>
          <div className='testimonials-avatar'>
            <img className='testimonials-avatar_image' src='https://github.com/jrop.png' />
          </div>
          ...
          <div className='testimonials-quote'>
            ...
            <div className='testimonials-name'>
              <Link href='https://github.com/jrop'>
                jrop
              </Link>
            </div>

            <div className='testimonials-text'>
              date-fns is the modular path to date/time manipulation. Where I work, it helped us get our bundle sizes down,
              especially because we are able to include only the functionality we need.
            </div>
          </div>
        </div>
        ...
        <div className='testimonials-item'>
          <div className='testimonials-avatar'>
            <img className='testimonials-avatar_image' src='https://github.com/MiracleBlue.png' />
          </div>
          ...
          <div className='testimonials-quote'>
            ...
            <div className='testimonials-text'>
              ...
              without worrying about conversion or mutations. It's a real game changer for dates.
            </div>
          </div>
        </div>
        ...
        <div className='testimonials-item'>
          <div className='testimonials-avatar'>
            <img className='testimonials-avatar_image' src='https://github.com/miljan-aleksic.png' />
          </div>
          ...
          <div className='testimonials-quote'>
            ...
            <div className='testimonials-name'>
              <Link href='https://github.com/miljan-aleksic'>
                Miljan Aleksic
              </Link>, Author of <Link href='https://vuikit.js.org/'>
                Vuikit
              </Link>
            </div>
